 ...
 */
package org.openmrs.module.hei.atomfeed.client.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.HEIAtomfeedclientController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class HEIAtomfeedclientController {
